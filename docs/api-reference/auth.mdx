...
**Note**: By default, Better Auth is **automatically disabled** unless you have configured at least one social provider (like GitHub or Google) and set the `DB_URL` environment variable.

**Configuration**:
You can explicitly enable or disable Better Auth in your `mcp_settings.json` file:
